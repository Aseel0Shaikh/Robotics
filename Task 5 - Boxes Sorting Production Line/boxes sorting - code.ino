...
void loop() {
  ...
  if(x==1 && y==0 && z==0){ //check if the box size is 10cm x 10cm
    ...
    motor.attach(10);  // attaches the motor on pin 10 to the servo object
    motor.write(45);   // tell servo to rotates 180 degrees
    ...
    motor.attach(10);  // attaches the motor on pin 10 to the servo object
    motor.write(90);   // tell servo to rotates 90 degrees
